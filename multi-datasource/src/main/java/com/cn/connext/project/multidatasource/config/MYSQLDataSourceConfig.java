...
@EnableJpaRepositories(
        ...
        basePackages = {"com.cn.connext.project.multidatasource.repository.mysql"}) //设置Repository所在位置
public class MYSQLDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactorymysql(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.cn.connext.project.multidatasource.entity.mysql") //设置实体类所在位置
